...
def get_pet_recommendations():
    ...
    # The script loads the dataset directly from your GitHub repository.
    # This URL points to the "raw" version of your CSV file.
    # IMPORTANT: Replace 'Nnennea' with your GitHub username if it's different.
