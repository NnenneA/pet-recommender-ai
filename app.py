...
# --- Load the Data ---
# We load the dataset once when the app starts.
try:
    ...
    # If we can't load the data, we can't run the app.
    # In a real app, you might have a fallback or a better error page.
